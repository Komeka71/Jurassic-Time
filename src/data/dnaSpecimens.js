...
export const availableSpecimens = [
  {
    ...
    name: 'Tyrannosaurus',
    designation: 'SPX-014',
    image: '/assets/dnalab/specimens/tyrannosaurus.webp',
  ...
  },
  {
    ...
    name: 'Spinosaurus',
    designation: 'SPX-021',
    image: '/assets/dnalab/specimens/spinosaurus.webp',
    status: SPECIMEN_STATUS.AVAILABLE,
  },
  {
    id: 'velociraptor',
    name: 'Velociraptor',
    designation: 'SPX-007',
    image: '/assets/dnalab/specimens/velociraptor.webp',
    status: SPECIMEN_STATUS.AVAILABLE,
  },
  {
    id: 'triceratops',
    name: 'Triceratops',
    designation: 'SPX-033',
    image: '/assets/dnalab/specimens/triceratops.webp',
    status: SPECIMEN_STATUS.AVAILABLE,
  },
];
...
export const archiveSpecimens = [
  {
    ...
    name: 'Ankylosaurus',
    designation: 'SPX-048',
    image: '/assets/dnalab/specimens/ankylosaurus.webp',
  ...
  },
  {
    ...
    name: 'Brachiosaurus',
    designation: 'SPX-052',
    image: '/assets/dnalab/specimens/brachiosaurus.webp',
    status: SPECIMEN_STATUS.LOCKED,
    badge: 'UNDER RESEARCH',
