...
// // Reuses one transporter across requests instead of reconnecting every time.
// // Works with Gmail (using an App Password, not your normal password) or any
// // other SMTP provider — just change the env vars, the code doesn't change.
...
// Built lazily (on first send) rather than at import time. If this ran at
// import time, it would read process.env before dotenv had necessarily
// finished loading it, silently baking in empty credentials.
