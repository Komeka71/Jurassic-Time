...
// Serve uploaded files (evidence images, etc.) with a relaxed
// Cross-Origin-Resource-Policy so they can be embedded from the
// Vercel-hosted frontend (a different origin than this API).
// Helmet's default CORP is "same-origin", which silently blocks
// <img> tags on other origins from loading these files.
app.use(
  "/uploads",
  (req, res, next) => {
