...
// True while the user is actively answering a quiz question, so the
// Chatbot can lock Paleo out of quiz-answer content on the backend.
// Reset to false once the reward chest / summary appears.
