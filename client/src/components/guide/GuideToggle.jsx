...
export default function GuideToggle({ position = "right" }) {
  ...
  // Pass position="left" explicitly wherever you DO want it to
  // show up while a tour is active.
  if (tourActive && position !== "left") return null;
