...
/**
 * MuseumIntro
 * Cinematic full-bleed video splash that plays above the functional
 * search hero (MuseumHero) on MuseumExplorer.
 *
 * Usage:
 *   <MuseumIntro
 *     videoSrc="/videos/museum-hero.mp4"
 *     posterSrc="/images/museum-hero-poster.jpg"
 *     primaryCta={{ label: "Explore Archive", onClick: () => {} }}
...
export default function MuseumIntro({
  ...
  description =
    "Step through the archive of Earth's deep past — walk reconstructed halls, examine verified fossil evidence, and trace the species that ruled before us.",
  primaryCta = { label: "Explore Archive", onClick: () => {} },
  secondaryCta = { label: "Virtual Tour", onClick: () => {} },
  ...
  return (
    <section className="mi-root" aria-label="Museum archive introduction">
      {/* Background layer */}
      <div className="mi-bg">
        <video
          className="mi-video"
        ...
        <div className="mi-vignette" />
        <div className="mi-grain" aria-hidden="true" />
      </div>
      ...
      <header className="mi-nav">
        <div className="mi-brand">
          ...
          <span className="mi-brand-text">
            ...
            <span className="mi-brand-sub">{subEyebrow}</span>
          </span>
        </div>
      ...
      {/* Field ledger ticker — signature element */}
      <div className="mi-ledger" role="status" aria-label="Live archive statistics">
        <div className="mi-ledger-track">
          {[...LEDGER_ITEMS, ...LEDGER_ITEMS].map((item, i) => (
            <span className="mi-ledger-item" key={i}>
              {item}
              <span className="mi-ledger-dot">•</span>
            </span>
          ))}
        </div>
      </div>
      ...
      <div className="mi-content">
        ...
        >
          <button className="mi-btn-primary" onClick={primaryCta.onClick}>
            {primaryCta.label}
          ...
          <button className="mi-btn-secondary" onClick={secondaryCta.onClick}>
      ...
      {/* Corner seal */}
      <div className="mi-seal" aria-hidden="true">
        <svg viewBox="0 0 60 60" width="40" height="40">
          <circle cx="30" cy="30" r="28" fill="none" stroke="currentColor" strokeWidth="0.8" />
          <circle cx="30" cy="30" r="23" fill="none" stroke="currentColor" strokeWidth="0.5" />
          <text
            x="30"
            y="20"
            textAnchor="middle"
      ...
      {/* Scroll cue */}
      <div className="mi-scroll-cue" aria-hidden="true">
