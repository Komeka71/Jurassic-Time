  ...
  return (
    <section className="museum-intro">
      <div className="mi-background" aria-hidden="true">
        <video className="mi-video" autoPlay muted loop playsInline poster={posterSrc}>
        ...
        <div className="mi-brand">
          <span className="mi-brand-mark" aria-hidden="true">
            <svg viewBox="0 0 24 24" width="18" height="18" fill="none">
              <path d="M4 20c2-6 4-9 8-9s6 3 8 9" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
      ...
      <div className="mi-seal" aria-hidden="true">
        <svg viewBox="0 0 60 60" width="40" height="40">
          ...
          <text x="30" y="20" textAnchor="middle" fontSize="5.5" fill="currentColor" letterSpacing="1.5">EST.</text>
          <text x="30" y="34" textAnchor="middle" fontSize="8" fill="currentColor" fontWeight="600">JT</text>
          <text x="30" y="45" textAnchor="middle" fontSize="4.5" fill="currentColor" letterSpacing="1">ARCHIVE</text>
        </svg>
      </div>
