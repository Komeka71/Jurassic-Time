        ...
        <AnimatePresence>
          {menuOpen && (
            <motion.div
              ...
              className="fixed inset-0 top-16 bg-black/60 "
            />
          )}
        </AnimatePresence>
...
{/* <div className="mx-5 mb-5 rounded-2xl border border-green-500/10 bg-[#111714] p-5">
  ...
  <p className="mt-2 text-sm leading-6 text-white/55">
    The apex predator of the Late Cretaceous with one of the strongest bite
    forces ever measured.
  </p>

  <button className="mt-4 text-sm font-medium text-green-300 hover:text-white transition">
    View Specimen →
  </button>
</div> */}
  {/* Footer */}
