...
export default function Navbar() {
  ...
  // ---------------------------------------------------------
  const handleMiniGamesClick = (event) => {
    if (event) {
    ...
    if (location.pathname === "/") {
      const miniGamesSection = document.getElementById("mini-games");

      if (miniGamesSection) {
        miniGamesSection.scrollIntoView({
          behavior: "smooth",
          block: "start",
        });

        // Keep the URL in sync
        window.history.replaceState(null, "", "/#mini-games");
      }
    ...
    // go to homepage with the Mini Games hash
    navigate("/#mini-games");
  };
            ...
            >
              ...
              >
                {navItems.map((item) => {
                  ...
                  // Mini Games gets special scroll behavior
