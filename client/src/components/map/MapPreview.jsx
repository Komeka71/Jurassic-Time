...
export default function MapPreview() {
  ...
  // "Click to enter the map" hint. Shows on every load, same as the
  // anatomy viewer hints — this is a low-key discovery aid, not a
  // one-time tutorial, so it isn't persisted anywhere.
  const [showGlobeHint, setShowGlobeHint] = useState(true);
  const [showGlobeHintMobile, setShowGlobeHintMobile] = useState(true);
      ...
      {visible && (
        ...
        >
          ...
          <span className="text-xs font-medium tracking-wide text-cyan-100">
            Click the globe to enter the map
          </span>
        </motion.div>
      )}
    </AnimatePresence>
  ...
  "
          >
            <motion.div
              ...
              onHoverStart={() => setShowGlobeHint(false)}
              className="
            relative
            -mt-10
...
xl:h-[620px]
            ...
            "
              ...
              >
                {isSafari ? (
                  ...
                  <source src="/videos/map/earth.webm" type="video/webm" />
                )}
              </motion.video>
              {/* Circular Click Area */}
              <button
  ...
  "
              ...
              {/* Click Hint */}
              <GlobeHint visible={showGlobeHint} />
            </motion.div>
          </div>
...
lg:h-[580px]
  ...
  "
            ...
            {/* Tap Hint */}
            <GlobeHint visible={showGlobeHintMobile} />
          </motion.div>
