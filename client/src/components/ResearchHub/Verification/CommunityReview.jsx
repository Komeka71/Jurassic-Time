    ...
    <section className="relative mt-36">
      ...
      {!hasReviews && (
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-16 rounded-3xl border border-dashed border-[#8b6a3d]/20 bg-[#1b140f] p-12 text-center"
        >
          <Users
            size={42}
          ...
          <p className="mt-3 text-[#bca88b]">
            This discovery is awaiting its first community review.
          </p>
        </motion.div>
      )}
          ...
          {reviewers.map((reviewer, index) => (
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex h-16 w-16 items-center justify-center rounded-full border border-[#8b6a3d]/30 bg-[#24180f]">
                  <ShieldCheck
                    size={30}
              ...
              {reviewer.createdAt && (
                <p className="mt-1 text-xs text-[#8f7b5d]">
                  Reviewed on{" "}
                  {new Date(
                    reviewer.createdAt
                  ).toLocaleDateString()}
              ...
              <div className="mt-8">
                {reviewer.verdict === "approved" ? (
                  ...
                  <span className="rounded-full border border-red-500/30 bg-red-500/10 px-4 py-2 text-xs uppercase tracking-[0.3em] text-red-400">
                    Rejected
                  </span>
                ) : (
