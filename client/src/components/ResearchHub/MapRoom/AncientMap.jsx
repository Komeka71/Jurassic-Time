  ...
  return (
    <>
      ...
      <div className="mb-10 text-center">
        <h2 className="text-4xl font-bold text-[#f5e4c4]">
          Global Fossil Discoveries
        </h2>

        <p className="mt-4 text-[#ccb998]">
          Explore major fossil excavation sites preserved within the Paleora
          Archive.
        </p>
      </div>
