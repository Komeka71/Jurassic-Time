    ...
    <>
            ...
            <div className="mt-8 rounded-2xl border border-[#8d693833] bg-[#231913] p-6">
              ...
              <div className="mt-5 space-y-3 text-[#ccb89a]">
                <p>
                  <strong>Archive ID:</strong> {archiveId}
                </p>
...
<p>
  ...
  className="flex-1 rounded-xl border border-[#8d6938] py-3 text-[#f6e5c6]"
>
  View Discovery
</button>
              ...
              <button
                onClick={onNew}
                className="flex-1 rounded-xl bg-[#8d6938] py-3 font-semibold text-[#fff2d6]"
              >
                Submit Another
              </button>
            </div>
