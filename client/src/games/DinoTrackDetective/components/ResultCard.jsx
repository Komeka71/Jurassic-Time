...
// import { dinosaurIllustrations, DefaultIllustration } from '../../../shared/illustrations/dinosaurs.jsx';

// export default function ResultCard({ dino, outcome, onNext, onLearnMore, isLastTrail }) {
//   const Illustration = dinosaurIllustrations[dino.id] || DefaultIllustration;
    ...
    <div className={`result-card result-card--${outcome}`}>
      <div className="result-card__media">
        <ArtworkImage
          id={dino.id}
          alt={dino.name}
          basePath="/assets/dino-detective/dinosaurs"   
          className="result-card__art"
          fallbackClassName="result-card__art result-card__art--fallback"
          fallback={<Illustration className="result-card__art-illustration" />}
        />
      ...
      <div className="result-card__body">
        ...
        <div className="result-card__facts">
          ...
          <div className="result-card__fact result-card__fact--wide">
            <span className="result-card__fact-label">
              Interesting Fact
            </span>
            <span className="result-card__fact-value">
              {dino.fact}
            </span>
          </div>
        </div>
