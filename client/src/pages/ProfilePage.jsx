...
import GuideToggle from "../components/guide/GuideToggle"; // adjust path to match actual location relative to this file
...
export default function ProfilePage() {
  ...
  return (
    <div className="relative min-h-screen bg-stone-950 px-4 py-8 md:px-8">
      <HomeButton onClick={() => navigate("/")} position="right" />
      ...
      {/* DinoGuide — fixed, page-level. Root now has `relative` so this
          isn't at the mercy of any transformed ancestor breaking `fixed`. */}
      <div
        className="
          fixed
          bottom-5
      ...
      {/* Shows the paw-print re-open button whenever the guide is hidden */}
      <GuideToggle />
    </div>
  );
}